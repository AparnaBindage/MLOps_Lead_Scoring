...
DATA_DIRECTORY = root_folder + 'airflow/dags/Lead_scoring_data_pipeline/data/leadscoring.csv'
INTERACTION_MAPPING = root_folder + 'airflow/dags/Lead_scoring_data_pipeline/mapping/interaction_mapping.csv'
