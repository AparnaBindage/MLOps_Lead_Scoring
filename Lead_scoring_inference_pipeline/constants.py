rootfolder = "/home/"
DB_PATH = rootfolder + "airflow/dags/Lead_scoring_data_pipeline/"
DB_FILE_NAME = "lead_scoring_data_cleaning.db"

DB_FILE_MLFLOW = rootfolder + "airflow/dags/Lead_scoring_training_pipeline/Lead_scoring_mlflow_production.db"

FILE_PATH = rootfolder + 'airflow/dags/Lead_scoring_inference_pipeline/prediction_distribution.txt'

TRACKING_URI = "http://0.0.0.0:6006"
ml_flow_path = 'runs:/3eb9bef0df6c40ffa8743d7302779c36/models'
...
ONE_HOT_ENCODED_FEATURES = ['first_platform_c_Level0', 'first_platform_c_Level1',
       ...
       'first_utm_source_c_others', 'city_tier', 'total_leads_droppped',
       'referred_lead']
